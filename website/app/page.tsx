  ...
  return (
    <main>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <motion.button
                              ...
                              className={`flex flex-col items-center justify-center p-8 border-2 border-dashed ${
                                isRecording ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-primary hover:bg-gray-50'
                              } rounded-xl transition-all duration-200`}
                            >
                              <div className={`p-3 ${isRecording ? 'bg-red-100' : 'bg-primary/10'} rounded-full mb-4`}>
                                <svg 
                                  className={`w-8 h-8 ${isRecording ? 'text-red-500' : 'text-primary'}`} 
                                  fill="none" 
                                  stroke="currentColor" 
                                  viewBox="0 0 24 24"
                                >
                            ...
                            <div className="mt-6 p-4 bg-gray-50 rounded-xl">
                              <div className="flex items-center gap-4">
                                ...
                                <button
                                  ...
                                  className={`bg-primary text-white px-6 py-2 rounded-lg text-sm transition-all duration-200 ${
                            ...
                            {uploadSuccess ? (
                              ...
                              <div className="space-y-4">
                                ...
                                <button 
                                  onClick={handleUpload}
                                  disabled={isUploading}
                                  className={`mt-4 bg-primary text-white px-4 py-2 rounded-lg text-sm transition-colors ${
                                    isUploading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-primary-dark'
                                  }`}
                                >
                                  {isUploading ? 'Uploading...' : 'Start Translation'}
                              ...
                              <>
                                ...
                                <div>
                                  ...
                                  <label
                                    htmlFor="file-upload"
                                    className="mt-3 bg-primary text-white px-4 py-2 rounded-lg text-sm hover:bg-primary-dark transition-colors inline-block cursor-pointer"
                                  >
            ...
            <div>
              ...
              >
                <Link 
                  ...
                  className="inline-flex items-center bg-primary text-white px-8 py-4 rounded-full text-lg font-medium group hover:bg-primary-dark transition-colors"
      ...
      <motion.section 
        ...
        viewport={{ once: false, amount: 0.1 }}
        transition={{ duration: 0.8 }}
        className="relative py-24 bg-primary/20"
      >
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 grid grid-rows-[auto_auto] gap-8">
              ...
              <div className="grid grid-cols-2 gap-8 h-full">
                ...
                <div className="bg-primary/20 rounded-3xl p-6 flex flex-col justify-between aspect-square">
      ...
      >
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Link href="/learn-more" className="text-primary font-semibold hover:text-primary-dark transition-all">
              Learn more →
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 text-white lg:pl-8">
              ...
              <div className="space-y-6 max-w-2xl">
                <p className="text-lg">
                  We are seeking <span className="text-primary">forward-thinking clients</span> that aim to build the next generation of access for sign language users.
                </p>
              ...
              <form className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200"
                  />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 resize-none"
                  />
                </div>
                <motion.button 
                  type="submit"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-primary text-white py-4 px-6 rounded-xl font-medium hover:bg-primary-dark transition-all duration-200"
                >
                  Send Message
                </motion.button>
              </form>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all duration-200 group">
                    ...
                    <div>
                      ...
                      <a href="mailto:Signapse@dtu.ac.in" className="text-gray-900 hover:text-primary transition-colors">Signapse@dtu.ac.in</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all duration-200 group">
                    ...
                    <div>
                      ...
                      <a href="https://twitter.com/Signapse" className="text-gray-900 hover:text-primary transition-colors">@Signapse</a>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="w-16 h-16 bg-primary rounded-xl p-1">
                    ...
                    >
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-gray-900">Rishabh Kumar</h4>
                    ...
                    >
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-gray-900">Raghav Aloria</h4>
